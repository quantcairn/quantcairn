    ...
    def ingest_ai_selection_report(self, report: dict[str, Any], candidates: Iterable[dict[str, Any]] | None = None) -> list[CandidateRecord]:
        ...
        for raw in candidate_rows:
            ...
            metadata = {
                ...
                "candidate_fallback": bool(raw.get("candidate_fallback", False)),
                "fallback_sources": list(raw.get("fallback_sources") or report.get("fallback_sources") or []),
                "mock_used": bool(raw.get("mock_used", False)),
                "mock_sources": list(raw.get("mock_sources") or report.get("mock_sources") or []),
                "degraded": bool(raw.get("degraded", False)),
                "degradation_reasons": list(raw.get("degradation_reasons") or report.get("degradation_reasons") or []),
                ...
                "data_mode": raw.get("data_mode") or report.get("data_mode") or market_context.get("data_mode") or "",
                "data_freshness": raw.get("data_freshness") or report.get("data_freshness") or market_context.get("data_freshness") or "",
            ...
            record = CandidateRecord.from_ai_candidate(
                ...
                data_mode=str(raw.get("data_mode") or report.get("data_mode") or market_context.get("data_mode") or ""),
                data_freshness=str(raw.get("data_freshness") or report.get("data_freshness") or market_context.get("data_freshness") or ""),
                ...
                mock_used=bool(raw.get("mock_used", report.get("mock_used", market_context.get("mock_used", False)))),
                mock_sources=tuple(raw.get("mock_sources") or report.get("mock_sources") or market_context.get("mock_sources") or ()),
                degraded=bool(raw.get("degraded", report.get("degraded", market_context.get("degraded", False)))),
                degradation_reasons=tuple(raw.get("degradation_reasons") or report.get("degradation_reasons") or market_context.get("degradation_reasons") or ()),
