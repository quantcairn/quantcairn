...
def _write_run_audit(result: dict[str, Any], *, dry_run: bool) -> None:
    ...
    audit_row = {
        ...
        "selection_freshness": result.get("selection_freshness"),
        "expected_selector_window": result.get("expected_selector_window"),
        "latest_committed_run_id": result.get("latest_committed_run_id"),
